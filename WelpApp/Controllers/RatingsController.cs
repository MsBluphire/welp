...
namespace WelpApp.Controllers
{
    public class RatingsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ApplicationUserID = new SelectList(db.ApplicationUsers, "Id", "ApplicationUserID");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "RatingID,ApplicationUserID,BusinessID,StarReview,TextReview")] Rating rating)
        {
            ...
            ViewBag.ApplicationUserID = new SelectList(db.ApplicationUsers, "Id", "ApplicationUserID", rating.ApplicationUserID);
            return View(rating);
        }
